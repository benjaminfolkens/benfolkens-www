...
const Aside = loadable(() => import('./aside'), {
  fallback: <Loading />,
});

console.log(kleur.bold().cyan('Readying Application!'));
        ...
        <main className='main' role='main'>
          <div className='main-container'>
            <section className='main-section'>
              <h1 className='main-section-h1title'>Title</h1>
              <h3 className='main-section-h3title'>Subtitle</h3>
              <div className='main-section-content'>
                <p className='main-section-p'>
                  ...
                  endures pains to avoid worse pains." The standard Lorem Ipsum
